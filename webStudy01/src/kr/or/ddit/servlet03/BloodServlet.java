...
public class BloodServlet extends HttpServlet{
	...
	public void init(ServletConfig config) throws ServletException {
		...
		bloodMap.put("B001", new String[] {"A", "/WEB-INF/blood/a.jsp"});
		bloodMap.put("B002", new String[] {"B", "/WEB-INF/blood/b.jsp"});
		bloodMap.put("B003", new String[] {"AB", "/WEB-INF/blood/ab.jsp"});
		bloodMap.put("B004", new String[] {"O", "/WEB-INF/blood/o.jsp"});
