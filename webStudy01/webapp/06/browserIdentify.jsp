...
<%
	...
	String remotiAddr = request.getRemoteAddr();
	...
	out.println(String.format(pattern, "remoteAddr", remotiAddr));
	out.println(String.format(pattern, "localAddr", localAddr));
	out.println(String.format(pattern, "localPort", localPort));
	out.println(String.format(pattern, "uri", uri));
	out.println(String.format(pattern, "url", url));
%>
</pre>
<table>
	<thead>
