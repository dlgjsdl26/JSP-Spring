...
<h4>Scope(영역)</h4>
<pre>
	: 웹 어플리케이션 내에서 데이터를 공유하기 위해 사용하는 저장공간
	: 해당 영역에 저장된 속성(attribute)데이터의 사용 범위에 따른 분류.
	: 각 기본 객체가 소유한 Map
	1. page Scope (pageContext) : 한 JSP 페이지 내에서만 유효.
	2. Request Scope (request) : 한 request가 유지되는 동안 유효.
	3. Session Scope (session) : 한 session이 유지되는 동안 유효.
	4. Application Scope (application) : 하나의 ServletContext가 유지되는 동안 유효.
